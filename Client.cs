...
namespace File_Manager_WPF
{
     public class Client
     {
        ...
        /* Construct Object */
        public Client(string hostIP, string userName, string password) { host = hostIP; user = userName; pass = password; }
        ...
        public List<Item> DirectoryListDetailed(string directory)
        {
            try
            {
                ...
                /* Read Each Line of the Response and Append a Pipe to Each Line for Easy Parsing */
                //try { while (ftpReader.Peek() != -1) { directoryRaw += ftpReader.ReadLine() + "|"; } }
                try { while (ftpReader.Peek() != -1) { directoryRaw.Add(ftpReader.ReadLine()); }
